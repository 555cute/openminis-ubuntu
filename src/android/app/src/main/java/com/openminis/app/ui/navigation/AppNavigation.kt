...
object Routes {
    ...
    /** OpenMinis Code fork: dev-mode Pi Agent chat. */
    const val PI_CHAT = "pi_chat"
    const val LOGS = "logs"
...
fun AppNavigation(
    ...
    NavHost(
        ...
        // OpenMinis Code: dev-mode Pi Agent chat. Lives as a sibling
        // of the main ChatScreen so the upstream Minis agent loop is
        // untouched.
        composable(Routes.PI_CHAT) {
            com.openminis.app.ui.pi.PiChatScreen(
                onBack = { navController.safePopBackStack() },
            )
        }
