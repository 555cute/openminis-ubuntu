...
class WebAppActivity : ComponentActivity() {
    ...
    companion object {
        ...
        // [OpenMinis Code] Mirrors the manifest filter on the
        // activity-alias, which we renamed to com.openminis.code.*
        // in the applicationId split so the fork can co-exist with
        // upstream Minis without intent-resolution races.
        const val ACTION_OPEN_WEBAPP = "com.openminis.code.action.OPEN_WEBAPP"
