...
the minimal Ubuntu rootfs, resolve it silently (log only, never touch stdout)
...
_RESOLVERS = {
    "npx": ["DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends nodejs npm"],
    "node": ["DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends nodejs npm"],
    "npm": ["DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends nodejs npm"],
    "python3": ["DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends python3 python3-pip"],
    "pip": ["DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends python3 python3-pip"],
